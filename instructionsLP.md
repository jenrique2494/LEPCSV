...
2) Generate Anki CSV Data minimun 80 cards (word, phrases or grammar): For each identified vocabulary word, I will extract relevant information and format it into a CSV file suitable for Anki import. The CSV will adhere to the exact structure :
...
[Example 1], [Example 2], [Example 3]: I will provide one to three example sentences using the word. These examples will aim to be natural and helpful for understanding the word's usage. If the provided transcript offers good examples, I will prioritize those, I always fill 3 the examples.



[Tags]: This will include the level (A1, A2, B1, B2, C1, C2).



```

3) Export a Clean CSV codesnippet that you can copy directly



4) The name of the document is the imput with extent ".csv",  like this LEP01.csv